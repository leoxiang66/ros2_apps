...
class MultiImageSubscriber(Node):
    def __init__(self):
        ...
        for i in range(num_cameras):
            ...
            publisher = self.create_publisher(Image, f'/cam_{i}/image_raw_rgb', 10)
...
def main(args=None):
    ...
    multi_image_subscriber = MultiImageSubscriber()
    rclpy.spin(multi_image_subscriber)
    multi_image_subscriber.destroy_node()
    rclpy.shutdown()
