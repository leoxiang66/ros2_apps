...
class TimestampSyncNode(Node):
    def __init__(self):
        ...
        self.image_arrive_times = []
        self.pc2_arrive_times = []
    ...
    def image_callback(self, msg):
        ...
        if self.image_index == CAPACITY and self.pc2_index == CAPACITY:
            ...
            for i in range(CAPACITY):
                ...
                print(f"image arrive timestamp: {nanosec2date(self.image_arrive_times[i])}")
                print(f"pc2 arrive timestamp: {nanosec2date(self.pc2_arrive_times[i])}")
            ...
            print(f'Average arrive time diff: {sum([- self.image_arrive_times[i] + self.pc2_arrive_times[i] for i in range(CAPACITY)])/CAPACITY}')
        ...
        self.image_arrive_times.append(self.get_clock().now().nanoseconds)
    ...
    def pc2_callback(self, msg):
        ...
        self.pc2_arrive_times.append(self.get_clock().now().nanoseconds)
